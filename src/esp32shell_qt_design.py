...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.text_error_output = QTextEdit(self.centralwidget)
        self.text_error_output.setObjectName(u"text_error_output")
        self.text_error_output.setGeometry(QRect(290, 350, 581, 181))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(300, 330, 101, 16))
        self.Repl = SerialTerminalWidget(self.centralwidget)
        self.Repl.setObjectName(u"Repl")
        self.Repl.setGeometry(QRect(290, 560, 581, 131))
        self.label_repl = QLabel(self.centralwidget)
        self.label_repl.setObjectName(u"label_repl")
        self.label_repl.setGeometry(QRect(300, 540, 90, 16))
        ...
        self.radioButton_commandmode.setGeometry(QRect(551, 20, 141, 20))
        ...
        self.radioButton_replmode.setGeometry(QRect(691, 20, 121, 20))
        self.label_comport = QLabel(self.centralwidget)
        self.label_comport.setObjectName(u"label_comport")
        self.label_comport.setGeometry(QRect(30, 10, 511, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Error Output", None))
